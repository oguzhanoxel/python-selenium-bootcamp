...
class TestSaucedemo:
	...
	def test_successful_order(self):
		...
		self.waitForElementVisible((By.CLASS_NAME, SaucedemoConstants.BUTTON_INVENTORY_CLASS_NAME))
		button_inventory = self.driver.find_elements(By.CLASS_NAME, SaucedemoConstants.BUTTON_INVENTORY_CLASS_NAME)

		button_inventory[0].click()

		self.waitForElementVisible((By.CLASS_NAME, SaucedemoConstants.SHOPPING_CART_LINK_CLASS_NAME))
		shopping_cart_link = self.driver.find_element(By.CLASS_NAME, SaucedemoConstants.SHOPPING_CART_LINK_CLASS_NAME)
		shopping_cart_link.click()

		self.waitForElementVisible((By.ID, SaucedemoConstants.CHECKOUT_BUTTON_ID))
		checkout_button = self.driver.find_element(By.ID, SaucedemoConstants.CHECKOUT_BUTTON_ID)
		checkout_button.click()

		self.waitForElementVisible((By.ID, SaucedemoConstants.FIRST_NAME_INPUT_ID))
		self.waitForElementVisible((By.ID, SaucedemoConstants.LAST_NAME_INPUT_ID))
		self.waitForElementVisible((By.ID, SaucedemoConstants.POSTAL_CODE_INPUT_ID))

		firstname_input = self.driver.find_element(By.ID, SaucedemoConstants.FIRST_NAME_INPUT_ID)
		lastname_input = self.driver.find_element(By.ID, SaucedemoConstants.LAST_NAME_INPUT_ID)
		postal_code_input = self.driver.find_element(By.ID, SaucedemoConstants.POSTAL_CODE_INPUT_ID)

		firstname_input.send_keys("Oğuzhan")
		lastname_input.send_keys("Öksel")
		postal_code_input.send_keys("3333")

		self.waitForElementVisible((By.ID, SaucedemoConstants.CONTINUE_BUTTON_ID))
		continue_button = self.driver.find_element(By.ID, SaucedemoConstants.CONTINUE_BUTTON_ID)
		continue_button.click()

		self.waitForElementVisible((By.ID, SaucedemoConstants.FINISH_BUTTON_ID))
		finish_button = self.driver.find_element(By.ID, SaucedemoConstants.FINISH_BUTTON_ID)
		finish_button.click()

		self.waitForElementVisible((By.CLASS_NAME, SaucedemoConstants.COMPLETE_HEADER_CLASS_NAME))
		complete_header = self.driver.find_element(By.CLASS_NAME, SaucedemoConstants.COMPLETE_HEADER_CLASS_NAME)
		expected_text = "Thank you for your order!"

		assert complete_header.accessible_name == expected_text
	...
	def test_order_count(self):
		...
		button_inventory[0].click()
		button_inventory[1].click()
		button_inventory[2].click()

		self.waitForElementVisible((By.CLASS_NAME, SaucedemoConstants.SHOPPING_CART_LINK_CLASS_NAME))
		shopping_cart_link = self.driver.find_element(By.CLASS_NAME, SaucedemoConstants.SHOPPING_CART_LINK_CLASS_NAME)
		shopping_cart_link.click()

		self.waitForElementVisible((By.CLASS_NAME, SaucedemoConstants.CART_ITEM_CLASS_NAME))
		card_items = self.driver.find_elements(By.CLASS_NAME, SaucedemoConstants.CART_ITEM_CLASS_NAME)

		expected_number = 3

		assert len(card_items) == expected_number
...
class SaucedemoConstants:
	...
	BUTTON_INVENTORY_CLASS_NAME = "btn_inventory"
	...
	COMPLETE_HEADER_CLASS_NAME = "complete-header"
	CHECKOUT_BUTTON_ID = "checkout"
	CART_ITEM_CLASS_NAME = "cart_item"
